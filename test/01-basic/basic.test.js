...
describe('basic', () => {
  ...
  it('#2 remove property from object', () => {
    const obj = basic.objWithNestedKey
  ...
  it('#3 reverse string', () => {
    const func = basic.reverseString
  ...
  it('#5 compare strings without string register', () => {
    const func = basic.compareStrings
  ...
  it('#6 get object and return string with all values', () => {
    ...
    const func = basic.strFromObjValues
  ...
  it('#8 get first and last elements from array', () => {
    const func = basic.getFirstAndLastElements
  ...
  it('#9 check if number is divisible', () => {
    const func = basic.isIntegerDivisible
  ...
  it('#10 calculate all odd numbers sum', () => {
    const func = basic.calculateAllOddNumbersSum
  ...
  it('#11 find count of positive even numbers in array ', () => {
    const func = basic.positiveEvenNumbersCount
